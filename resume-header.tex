...
\cfoot{\color{gray}\textcolor{gray}{\footnotesize{Otto Ilmari Koria (\greyunderline{https://www.ilmarikoria.xyz}{www.ilmarikoria.xyz}) --- Résumé: Updated \today{} (\greyunderline{https://www.git.ilmarikoria.xyz/?p=resume.git;a=summary}{Source Git}) --- References available on request.}}}
