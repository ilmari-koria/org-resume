...
** Technical Tools
@@latex:\bulletlist@@
- *Markup*: \texttt{XML, HTML, CSS, \LaTeX} --- *Scripting and Querying*: =Lisp, Python, XSL/XSLT, XPath, XQuery= --- *Development*: =GNU/Linux (Debian), Bash, PowerShell, OpenAI, BaseX, Git, oXygen, GNU Emacs=.
