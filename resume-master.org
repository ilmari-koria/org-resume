...
** Technical Tools
# consolidate this
- *Markup, styling, schema*: XML, HTML, CSS, \LaTeX{}, XSL/XSLT, Schematron --- *Scripting and querying*: Python, XPath, XQuery --- *Development*: GNU/Linux (Debian, Ubuntu), shell (Bash, PowerShell), OpenAI (ChatGPT), BaseX, Git (and GitHub), oXygen, GNU Emacs, Atlassian (Jira, Trello).
** Language Proficiency
- *English*: advanced --- *Finnish*: advanced --- *Mandarin*: high-intermediate @@latex:\chtex{中高級}@@.
