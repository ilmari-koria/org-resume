...
** Education
#+ATTR_LATEX: :environment tabularx :align lXr :width \textwidth
...
** Technical Training
#+ATTR_LATEX: :environment tabularx :align Xlllr :width \textwidth
| [[https://www.udemy.com/certificate/UC-11294ef2-5e24-498a-8d7b-0eca9fe72b29/][Practical Transformation Using XSLT and XPath]]         | 2024 | 24 hrs. | G. Ken Holman/Udemy  | Online course |
| DHOxSS Applied Data Analysis for the Humanities       | 2019 | 25 hrs. | University of Oxford | Oxford        |
| Introduction to Python: Data Analysis and Programming | 2019 | 25 hrs. | University of London | London        |

** Tools and Language Skills
#+ATTR_LATEX: :environment tabularx :align lX :width \textwidth
| *XML:*                | XSLT, XQuery, Schematron, DocBook, TEI                                                       |
| *Markup & Scripting:* | HTML, CSS, \LaTeX{}, Bash, Batch/cmd.exe                                                     |
| *Development:*        | BaseX (NoSQL), oXygen, GNU/Linux Debian, Git, GNU Emacs, Atlassian (Jira, Trello)            |
|                       |                                                                                              |
