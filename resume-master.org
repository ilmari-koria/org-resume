...
** Technical Tools
- *XML:* XSL/XSLT, XPath, XQuery, Schematron, BaseX, oXygen, DocBook --- *Markup & Scripting:* HTML, CSS, \LaTeX{}, Python, shell (Bash, PowerShell) ---  *Development*: GNU/Linux (Debian, Ubuntu), Git, GNU Emacs, Atlassian (Jira, Trello).
