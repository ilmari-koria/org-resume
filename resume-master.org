...
#+begin_center
Résumé: \today{} --- [[mailto:ilmarikoria@posteo.net][ilmarikoria@posteo.net]] --- [[https://github.com/ilmari-koria/org-resume][GitHub]] --- @@latex:\chtex{華文姓名：}\ruby{\chtex{柯}}{Kē}\ruby{\chtex{萬}}{Wàn}\ruby{\chtex{里}}{lǐ}@@
#+end_center
...
** Technical Tools
- *XML:* XSLT, XQuery, Schematron, XProc --- *Markup & Scripting:* HTML, CSS, \LaTeX{}, Python, Bash, Batch/cmd.exe --- *Development*: BaseX (NoSQL), oXygen, GNU/Linux Debian, Git, GNU Emacs, Atlassian (Jira, Trello).
