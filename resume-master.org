...
** Technical Tools
- *XML:* XSL, XPath, XQuery, Schematron, BaseX, oXygen --- *Markup & Scripting:* HTML, CSS, \LaTeX{}, Python, shell (Bash) --- *Development*: Excel, GNU/Linux (Debian), Git, GNU Emacs, Atlassian (Jira, Trello).
