...
#+export_file_name: /home/ilmari/my-files/blog/ilmarikoria/ilmari-koria-resume
...
# these should be specific achievements
...
** Technical Tools
# max two lines, every skill must be qualified
- *XML:* XProc, XSL, XPath, XQuery, Schematron, BaseX, oXygen --- *Markup & Scripting:* HTML, CSS, \LaTeX{}, Python, shell (Bash, PowerShell) ---  *Development*: GNU/Linux (Debian), Git, GNU Emacs, Atlassian (Jira, Trello).
